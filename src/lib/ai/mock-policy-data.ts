...
export interface PolicyData {
  ...
  additionalCoverages: {
    ...
    reasonableEmergencyMeasures?: number;
    emergencyRemoval?: number;
    powerInterruption?: number;
    collapse?: number;
    glassReplacement?: number;
    landlordssFurnishings?: number;
    graveMarkers?: number;
    creditCardForgery?: number;
    lossAssessment?: number;
    claimExpenses?: number;
    firstAidExpenses?: number;
    damageToPropertyOfOthers?: number;
  };
