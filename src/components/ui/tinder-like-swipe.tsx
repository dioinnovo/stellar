...
export function SwipeableCardStack({
  ...
  const handleDrag = (_event: any, info: any, index: number) => {
  ...
  const handleDragEnd = (_event: any, info: any, index: number) => {
  ...
  const handleSwipe = (index: number, direction: string | null) => {
